...
**Note:** The loop can operate in two modes:
1. **Legacy mode**: Reads IMPLEMENTATION_PLAN.md directly
2. **SOP mode**: Reads .code-task.md files generated by sop-task-generator

PROMPT_build.md supports both modes automatically.
