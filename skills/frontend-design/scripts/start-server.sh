...
#
# Options:
#   --project-dir <path>  Store session files under <path>/.visual-companion/sessions/
...
if [[ -n "$PROJECT_DIR" ]]; then
  SCREEN_DIR="${PROJECT_DIR}/.visual-companion/sessions/${SESSION_ID}"
else
  SCREEN_DIR="/tmp/visual-companion-${SESSION_ID}"
fi
